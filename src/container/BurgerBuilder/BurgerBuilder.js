    ...
    render(){
        ...
        return(
            <Aux>
                ...
                <BuildControls purchable={this.state.purchable} disable={disabledInfo} ingredientsAdd={this.addIngredientsHandler} ingredientsRemove={this.removeIngredients} price={this.state.totalPrice} ></BuildControls>
            </Aux>
        );
    };
}
